<x-app-layout>
    <x-container.game x-data="{ current: 0, max_index: {{ $phases->count() - 1 }}}">
        <div class="bg-white shadow-2xl block fixed inset-x-0 bottom-0 z-10 lg:hidden space-x-0 flex flex-row space-x-4">
            <x-game.nav-link-mobile :link="route('games.show', $game)" icon-active="heroicon-s-map" icon-inactive="heroicon-o-map" :is-active="request()->routeIs('games.show')">
                Karte
            </x-game.nav-link-mobile>
            <x-game.nav-link-mobile icon-active="heroicon-s-mail" icon-inactive="heroicon-o-mail" :is-active="!request()->routeIs('games.show')">
                Nachrichten
            </x-game.nav-link-mobile>
        </div>
        <div class="flex lg:space-x-5">
            ...
            {{-- Navigation desktop --}}
            <div class="w-1/6 items-start hidden lg:block">
                <div class="sticky top-10 space-y-1">
                    ...
                    <x-game.nav-link-desktop :is-active="!request()->routeIs('games.show')">Nachrichten
                    </x-game.nav-link-desktop>
            ...
            <div class="pb-[25px] lg:pb-0">
                ...
                <div class="flex justify-center mt-3 text-gray-500">
                    <button x-on:click="current = max_index" x-bind:disabled="current == max_index"
